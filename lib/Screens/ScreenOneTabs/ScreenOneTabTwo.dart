...
class TabTwoForScreenOne extends StatefulWidget {
  const TabTwoForScreenOne({Key? key}) : super(key: key);

  @override
  _TabTwoForScreenOneState createState() => _TabTwoForScreenOneState();
}

class _TabTwoForScreenOneState extends State<TabTwoForScreenOne> {
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "NEXT 10 DAYS",
                        style: TextStyle(
                            color: MyColors.subTextBlack, fontSize: 12),
                      ),
